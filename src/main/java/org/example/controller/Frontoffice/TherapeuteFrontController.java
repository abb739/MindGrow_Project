...
public class TherapeuteFrontController {
    ...
    public void initialize() {
        ...
        aiBtn.setStyle(
                "-fx-background-color: #A2D5AB; -fx-text-fill: #4A4A4A; -fx-background-radius: 25; -fx-cursor: hand; -fx-padding: 8 20; -fx-font-weight: bold; -fx-effect: dropshadow(gaussian, rgba(162, 213, 171, 0.3), 10, 0, 0, 3);");
    ...
    private void ouvrirDialogueAIConsultant() {
        ...
        suggestBtn.setStyle(
                "-fx-background-color: #6c5ce7; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10;");
    ...
    private void highlightChip(Button b) {
        b.setStyle(
                "-fx-background-color: #A2D5AB; -fx-text-fill: white; -fx-background-radius: 20; -fx-cursor: hand; -fx-padding: 6 18; -fx-font-weight: bold;");
    }
    ...
    private VBox buildCard(Therapeute t) {
        ...
        card.setStyle(
                "-fx-background-color: white; -fx-background-radius: 20; -fx-padding: 20; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.05), 15, 0, 0, 5); -fx-border-color: #f1f5f9; -fx-border-radius: 20; -fx-border-width: 1;");
        ...
        specLabel.setStyle(
                "-fx-background-color: #e8f4f8; -fx-text-fill: #0b7a8f; -fx-padding: 4 12; -fx-background-radius: 15; -fx-font-size: 11; -fx-font-weight: bold;");
        ...
        avisBtn.setStyle(
                "-fx-background-color: #f39c12; -fx-text-fill: white; -fx-background-radius: 8; -fx-cursor: hand; -fx-font-weight: bold; -fx-font-size: 11;");
        ...
        card.setOnMouseEntered(e -> card.setStyle(
                "-fx-background-color: white; -fx-background-radius: 16; -fx-effect: dropshadow(three-pass-box, rgba(11,122,143,0.25), 16, 0, 0, 6); -fx-padding: 20; -fx-translate-y: -5; -fx-cursor: hand;"));
        card.setOnMouseExited(e -> card.setStyle(
                "-fx-background-color: white; -fx-background-radius: 16; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.08), 10, 0, 0, 4); -fx-padding: 20; -fx-translate-y: 0;"));
    ...
    private void ouvrirDialogueAvis(Therapeute t, VBox cardRef) {
        ...
        envoyerBtn.setStyle(
                "-fx-background-color: #f39c12; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 5;");
    ...
    private StackPane buildAvatar(Therapeute t) {
        ...
        if (t.getImage() != null && !t.getImage().isEmpty()) {
            try {
                ImageView imgView = new ImageView(new Image(new File(t.getImage()).toURI().toString()));
