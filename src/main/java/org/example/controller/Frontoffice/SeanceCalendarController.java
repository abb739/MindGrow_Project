...
public class SeanceCalendarController {
    ...
    private VBox createDayCell(LocalDate date) {
        ...
        cell.setStyle("-fx-background-color: white; -fx-background-radius: 10; -fx-border-color: #ecf0f1; -fx-border-radius: 10; -fx-cursor: hand;");
        ...
        if (!seancesOnDate.isEmpty()) {
            ...
            indicator.setStyle("-fx-background-color: #0b7a8f; -fx-background-radius: 5; -fx-padding: 2 5;");
