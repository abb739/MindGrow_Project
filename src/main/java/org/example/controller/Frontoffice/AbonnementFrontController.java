...
public class AbonnementFrontController {
    ...
    private VBox createAbonnementCard(Abonnement a) {
        ...
        badge.setStyle("-fx-background-color: #e8f4f8; -fx-text-fill: #0b7a8f; -fx-padding: 5 12; -fx-background-radius: 20; -fx-font-weight: bold; -fx-font-size: 11px;");
        ...
        card.setOnMouseEntered(e -> card.setStyle("-fx-background-color: white; -fx-background-radius: 15; -fx-effect: dropshadow(three-pass-box, rgba(11,122,143,0.3), 15, 0, 0, 8); -fx-padding: 30; -fx-translate-y: -5;"));
        card.setOnMouseExited(e -> card.setStyle("-fx-background-color: white; -fx-background-radius: 15; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.1), 10, 0, 0, 5); -fx-padding: 30; -fx-translate-y: 0;"));
